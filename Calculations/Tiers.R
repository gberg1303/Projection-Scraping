...
if(week == 0){scoreThreshold <- c(QB = 10, RB = 10, WR = 10, TE = 10, K = 5, DST = 5, DL = 10, LB = 10, DB = 10)}
if(week > 0){scoreThreshold <- c(QB = .5, RB = .8, WR = .8, TE = .65, K = .2, DST = .1, DL = 10, LB = 10, DB = 10)}
